...
Vagrant.configure(2) do |config|
  ...
  config.vm.synced_folder ".", "/home/rails_tuto/current"
...
FLUSH PRIVILEGES;
CREATE USER 'rails_tuto'@'localhost';
SET PASSWORD FOR 'rails_tuto'@'localhost' = PASSWORD('password');
CREATE DATABASE rails_tuto_development DEFAULT CHARACTER SET utf8 DEFAULT COLLATE utf8_general_ci;
CREATE DATABASE rails_tuto_test DEFAULT CHARACTER SET utf8 DEFAULT COLLATE utf8_general_ci;
GRANT ALL PRIVILEGES ON rails_tuto_development.* to 'rails_tuto'@'localhost';
GRANT ALL PRIVILEGES ON rails_tuto_test.* to 'rails_tuto'@'localhost';
SQL
